...
<head>
  <title>Change Profile Image | MyChat</title>
</head>
         ...
         <input type="file" name="file"><br>
          ...
          <?php
               ...
               if(isset($_GET['change']) && $_GET['change'] == "cover")
               {
                   ...
                   echo "<img src='$user_data[cover_image]' style='max_width:500px;' >";
          
               } else
               {
                   
                echo "<img src='$user_data[profile_image]' style='max_width:500px;'>";
